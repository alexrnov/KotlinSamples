...
object ContextSamples {
  ...
  fun main(args: Array<String>) {
    ...
    // Иногда удобно иметь возможность передавать некоторые локальные данные
    // потока в сопрограммы или между ними. Однако, поскольку они не связаны с
    // каким-либо конкретным потоком, это, скорее всего, приведет к утечке памяти,
